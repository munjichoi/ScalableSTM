...
# """
# In order to implement this code, modify below as necessary
# """

# sampler = LdaSampler(n_topics=4, beta=2, psi=Psi_try, design_matrix=X_try, B0=B0_try)

# sampler.run(dtm_try, 10, 5)

# Final_posterior = (sampler.post_z, sampler.post_eta, sampler.post_lamb, sampler.post_B, sampler.post_Sigma)

# with open("path/to/directory","wb") as f:
